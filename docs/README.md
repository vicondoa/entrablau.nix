...
| [Reference: Options](./reference/options.md) | Full `nixosEntraId.*` option reference and v0.1.0 → v1.0.0 migration table |
...
All options live under `nixosEntraId.*`. The namespace is stable from
